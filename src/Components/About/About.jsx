  ...
  return (
    <div id="about" className="about_container">
      <div className="about_heading">
        <h2>
          Know <span>About</span> Me And My <span>Experience</span>
        </h2>
      </div>
        ...
        <SimpleGrid columns={[1, 1, 1, 2]}>
          ...
          <div className="about_box2">
            <div>
              <Box>
                <div className="me">
                  Hey! I am Vikash Kumar Lal & I enjoy creating things that
            ...
            {btn ? (
              <div>
                <Box>
                  <ul>
                    <li>
                      Hello! My name is vikash lal and I enjoy creating things
