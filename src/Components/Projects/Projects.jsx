              ...
              >
                ...
                <div className="project_icon">
                  <div className="github_link">
                    <a
                      href="https://github.com/Therobo77/omniscient-sheet-6598"
            ...
            <Box>
              ...
              >
                ...
                <div className="project_icon">
                  <div className="github_link">
                    <a
                      href="https://github.com/Therobo77/tense-visitor-349"
                      rel="noopener norefferer"
                      target="_blank"
                    >
                      <FaGithub />
            ...
            <Box>
              ...
              >
                ...
                <div className="project_icon">
                  <div className="github_link">
                    <a
                      href="https://github.com/Therobo77/brief-shirt-7318"
                      rel="noopener norefferer"
                      target="_blank"
                    >
                      <FaGithub />
            ...
            <Box>
              ...
              >
                ...
                <div className="project_icon">
                  <div className="github_link">
                    <a
                      href="https://github.com/Therobo77/Weather_App"
                      rel="noopener norefferer"
                      target="_blank"
                    >
                      <FaGithub />
                  ...
                  <div className="deploy_link">
                    <a
                      href="https://vikash-weather-app.vercel.app/"
                      rel="noopener norefferer"
                      target="_blank"
                    >
                      <FaEye />
            ...
            <Box>
              ...
              >
                ...
                <div className="project_icon">
                  <div className="github_link">
                    <a
                      href="https://github.com/vikashlal66/Language_Translator_App"
                      rel="noopener norefferer"
                      target="_blank"
                    >
                      <FaGithub />
                  ...
                  <div className="deploy_link">
                    <a
                      href="https://vikash-language-translator-app.vercel.app/"
                      rel="noopener norefferer"
                      target="_blank"
                    >
                      <FaEye />
            ...
            <Box>
              ...
              >
                ...
                <div className="project_icon">
                  <div className="github_link">
                    <a
                      href="https://github.com/vikashlal66/YouTube_Clone"
                      rel="noopener norefferer"
                      target="_blank"
                    >
                      <FaGithub />
            ...
            <Box>
              ...
              >
                ...
                <div className="project_icon">
                  <div className="github_link">
                    <a
                      href="https://github.com/vikashlal66/Rymo_Clone"
                      rel="noopener norefferer"
                      target="_blank"
                    >
                      <FaGithub />
            ...
            {/* <Box>
              <div className="project_box">
                ...
                <div className="project_icon">
                  <div className="github_link">
                    <a
                      href="https://github.com/vikashlal66/Weather_App/tree/main/weather_app"
                      rel="noopener norefferer"
                      target="_blank"
                    >
                      <FaGithub />
            ...
            <Box>
              ...
              >
                ...
                <div className="project_icon">
                  <div className="github_link">
                    <a
                      href="https://github.com/vikashlal/ndtv"
                      rel="noopener norefferer"
                      target="_blank"
                    >
                      <FaGithub />
            ...
            <Box>
              ...
              >
                ...
                <div className="project_icon">
                  <div className="github_link">
                    <a
                      href="https://github.com/vikashlal/ZoomCar"
                      rel="noopener norefferer"
                      target="_blank"
                    >
                      <FaGithub />
